...
////////////////////////////////////////////////////////////// // are
	void setareSchedule(EVMSchedule _areSchedule) const { areSchedule = _areSchedule; }

	EVMSchedule& getareSchedule() const { return areSchedule; }
...
private:
	...
	mutable EVMSchedule areSchedule; // are
