Contributing to ARENON
============================

The ARENON project operates an open contributor model where anyone is
...
The following applies to code changes to the ARENON project, and is not to be
confused with overall are Network Protocol consensus changes.

Whether a pull request is merged into ARENON rests with the project merge
...
Patches that change are consensus rules are considerably more involved than
...
Where a patch set proposes to change the are consensus, it must have been
...
The project leader is the release manager for each ARENON release.
