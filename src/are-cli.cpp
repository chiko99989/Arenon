...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("arecore RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                        "  are-cli [options] <command> [params]  " + _("Send command to arecore") + "\n" +
                        "  are-cli [options] help                " + _("List commands") + "\n" +
                        "  are-cli [options] help <command>      " + _("Get help for a command") + "\n";
