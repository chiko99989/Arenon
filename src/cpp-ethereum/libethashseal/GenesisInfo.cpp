...
#include "genesis/areMainNetwork.cpp"
#include "genesis/areTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
	...
	case Network::areMainNetwork: return c_genesisInfoareMainNetwork;
	case Network::areTestNetwork: return c_genesisInfoareTestNetwork;
	default:
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
	...
	case Network::areMainNetwork: return c_genesisStateRootareMainNetwork;
	case Network::areTestNetwork: return c_genesisStateRootareTestNetwork;
	default:
		throw std::invalid_argument("Invalid network value");
	}
}
