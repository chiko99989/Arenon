                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    resize(1185, 735);
    QString windowTitle = tr("arecore") + " - ";
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a are address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and are: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About arecore"), this);
    aboutAction->setStatusTip(tr("Show information about arecore"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for are"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your are addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified are addresses"));
    ...
    openAction->setStatusTip(tr("Open a are: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the arecore help message to get a list with possible are command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("arecore client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to are network", "", count));
}
...
{
    QString strTitle = tr("arecore"); // default title
