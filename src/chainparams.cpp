...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of
            ( 0,   uint256("0x9efaadbddf7e1705c57d0d5a2f6e752c371a6e075198ccb7021e35e305a3fa1c") );
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("3df513c016ed915287cf3cff222989769417e87654b679228c91e26e26900eb9fd053cd9f16a9a2894ad5ebbd551be1a4bd23bdaaa23679be17f3e21a16e6fbeba");
        nDefaultPort = /*28666*/ 22937;
        ...
        assert(hashGenesisBlock == uint256("0xf86c0facbd4f8c7b7387ced2faff3c28e2c707058364c9fcd57a34c558a2a3aa"));
        assert(genesis.hashMerkleRoot == uint256("0xc0a27673e326d60044bb232de9406af166326759ef835f73acdd72e4f1f44fd8"));
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 30 * 60; // are: 1 day
        nTargetSpacing = 3 * 60;  // are: 1 minute
        nLastPOWBlock = 6000000;
        nMaturity = 79;
...
//        assert(hashGenesisBlock == uint256("0"));
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("aretest1", "88.198.192.110"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet are addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet are script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet are BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet are BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet are BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nMinerThreads = 1;
        nMaturity = 2;
        nTargetTimespan = 24 * 60 * 60; // are: 1 day
        nTargetSpacing = 1 * 60;        // are: 1 minutes
        bnProofOfWorkLimit = ~uint256(0) >> 1;
