...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of
            ( 0,   uint256("0xed2f839e79a37ca950778a816113d62aed34962bd905274c7dbd87a46b250428") );

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1524353717, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1524353717; //22/04/2018
        ...
        assert(hashGenesisBlock == uint256("0xed2f839e79a37ca950778a816113d62aed34962bd905274c7dbd87a46b250428"));
        assert(genesis.hashMerkleRoot == uint256("0xab2caaf670ce9e626578c48e40c24a296396f189823d56fe762803ca9b9d2676"));

        vSeeds.push_back(CDNSSeedData("85.214.211.186", "85.214.211.186")); // DNSSeed
...
//        assert(hashGenesisBlock == uint256("0"));
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("85.214.211.186", "85.214.211.186"));
