...
In order to support loading of multiple wallets in are-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is are.cpp.
...
Changes to are.cpp
----------------------
are.cpp is the entry point into are-qt, and as such, will require some minor modifications to provide hooks for
