...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* are features */
        {"are", "masternode", &masternode, true, true, false},
        //{"are", "masternodelist", &masternodelist, true, true, false},
        //{"are", "mnbudget", &mnbudget, true, true, false},
        //{"are", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        //{"are", "mnfinalbudget", &mnfinalbudget, true, true, false},
        //{"are", "mnsync", &mnsync, true, true, false},
        {"are", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        //{"are", "darksend", &darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use ared, or the -server option to are-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> are-cli " + methodname + " " + args + "\n";
}
