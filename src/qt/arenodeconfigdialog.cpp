...
#include "ui_arenodeconfigdialog.h"

#include <QModelIndex>

areNodeConfigDialog::areNodeConfigDialog(QWidget *parent, QString nodeAddress, QString privkey) :
    QDialog(parent),
    ui(new Ui::areNodeConfigDialog)
{
    ui->setupUi(this);
...
areNodeConfigDialog::~areNodeConfigDialog()
{
    delete ui;
}
