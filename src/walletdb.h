...
public:
    ...
    bool WriteareNodeConfig(std::string sAlias, const CareNodeConfig& nodeConfig);
    bool ReadareNodeConfig(std::string sAlias, CareNodeConfig& nodeConfig);
    bool EraseareNodeConfig(std::string sAlias);
