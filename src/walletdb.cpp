...
bool CWalletDB::WriteareNodeConfig(std::string sAlias, const CareNodeConfig& nodeConfig)
{
    nWalletDBUpdated++;
    return Write(std::make_pair(std::string("adrenaline"), sAlias), nodeConfig, true);
}

bool CWalletDB::ReadareNodeConfig(std::string sAlias, CareNodeConfig& nodeConfig)
{
    return Read(std::make_pair(std::string("adrenaline"), sAlias), nodeConfig);
}

bool CWalletDB::EraseareNodeConfig(std::string sAlias)
{
    nWalletDBUpdated++;
