...
#ifndef are_TRADINGDIALOG_H
#define are_TRADINGDIALOG_H
...
private slots:
    ...
    void showBalanceOfareOnTradingTab();
    ...
    void showBalanceOfareOnSendTab();
    void showBalanceOfareOnBalanceTab();
    ...
    QString Buyare(QString OrderType, double Quantity, double Rate);
    QString Sellare(QString OrderType, double Quantity, double Rate);
    ...
    QString sendRequest(QString url, QString method = "GET", QString body = QString("{\"market\":\"are/BTC\"}"));// "{\"gender\":\"male\"}");
    void sendRequest1(QString url, std::function<void (void)> funcForCallAfterReceiveResponse, QString method = "GET", QString body = QString("{\"market\":\"are/BTC\"}"));// "{\"gender\":\"male\"}");
